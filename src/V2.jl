...
Base.@kwdef mutable struct UnitDefinition
    ...
    """
    base_units::Union{Vector{ BaseUnit }, Nothing} = nothing
...
Base.@kwdef mutable struct MeasurementData
    ...
    """
    data_unit::Union{ UnitDefinition, Nothing} = nothing
    ...
    """
    time_unit::Union{ UnitDefinition, Nothing} = nothing
...
Base.@kwdef mutable struct Measurement
    ...
    """
    species_data::Union{Vector{ MeasurementData }, Nothing} = nothing
    ...
    """
    temperature_unit::Union{ UnitDefinition, Nothing} = nothing
...
Base.@kwdef mutable struct Parameter
    ...
    """
    unit::Union{ UnitDefinition, Nothing} = nothing
    ...
    optimization.
    """
    fit::Union{ Bool, Nothing} = nothing
...
Base.@kwdef mutable struct Equation
    ...
    """
    variables::Union{Vector{ Variable }, Nothing} = nothing
...
Base.@kwdef mutable struct Reaction
    ...
    """
    kinetic_law::Union{ Equation, Nothing} = nothing

    """
    List of reactants that are part of the reaction.
    """
    reactants::Union{Vector{ ReactionElement }, Nothing} = nothing

    """
    List of products that are part of the reaction.
    """
    products::Union{Vector{ ReactionElement }, Nothing} = nothing

    """
    List of reaction elements that are not part of the reaction but
    influence it.
    """
    modifiers::Union{Vector{ ModifierElement }, Nothing} = nothing
...
Base.@kwdef mutable struct EnzymeMLDocument
    ...
    """
    creators::Union{Vector{ Creator }, Nothing}

    """
    Contains descriptions of all vessels that are part of the experiment.
    """
    vessels::Union{Vector{ Vessel }, Nothing}
    ...
    """
    proteins::Union{Vector{ Protein }, Nothing} = nothing

    """
    Contains descriptions of all complexes that are part of the experiment
    that may be referenced in reactions, measurements, and equations.
    """
    complexes::Union{Vector{ Complex }, Nothing} = nothing

    """
    Contains descriptions of all reactants that are part of the experiment
    that may be referenced in reactions, measurements, and equations.
    """
    small_molecules::Union{Vector{ SmallMolecule }, Nothing} = nothing
